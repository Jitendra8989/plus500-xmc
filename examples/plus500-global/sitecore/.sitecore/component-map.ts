...
import * as BulletList from 'components/React-Ref-Components/BulletList';
...
import * as CTASection from 'components/React-Ref-Components/CTASection';
import * as FAQAccordion from 'components/React-Ref-Components/FAQAccordion';
import * as FooterNavigationCallout from 'components/footer-navigation-callout/FooterNavigationCallout.dev';
import * as Footer from 'components/React-Ref-Components/Footer/Footer';
...
import * as Header from 'components/React-Ref-Components/Header/Header';
import * as Hero from 'components/hero/Hero';
import * as HeroSection from 'components/React-Ref-Components/HeroSection';
import * as Icon from 'components/icon/Icon';
import * as ImageBlock from 'components/image/ImageBlock';
import * as ImageWithCaption from 'components/React-Ref-Components/ImageWithCaption';
...
import * as CategoryInstrumentsRail from 'components/React-Ref-Components/CategoryInstrumentsRail';
import * as TestimonialGrid from 'components/React-Ref-Components/TestimonialGrid';
...
export const componentMap = new Map<string, NextjsContentSdkComponent>([
  ...
  ['Card', Card],
  ['CategoryInstrumentsRail', CategoryInstrumentsRail],
