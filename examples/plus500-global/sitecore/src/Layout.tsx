...
const Layout = ({ page }: LayoutProps): JSX.Element => {
  ...
  const classNamesMain = `${mainClassPageEditing} ${body.variable} ${heading.variable} ${inter.variable} main-layout`;
    ...
    <>
      ...
      <VideoProvider>
        ...
        <ThemeProvider attribute="class" disableTransitionOnChange>
          <div className={`min-h-screen flex flex-col font-sans antialiased bg-background text-foreground ${classNamesMain}`}>
