...
export function middleware(req: NextRequest, ev: NextFetchEvent) {
  console.log('\n=== MAIN MIDDLEWARE DEBUG ===');
  console.log('Request URL:', req.url);
  console.log('Request pathname:', req.nextUrl.pathname);
  console.log('Request search params:', req.nextUrl.search);
  ...
  if (!scConfig.api?.edge?.contextId) {
    console.log('[Main Middleware] No Edge contextId, skipping middlewares');
  ...
  console.log('[Main Middleware] Executing defineMiddleware...');
  const result = defineMiddleware(multisite, redirects, personalize).exec(req, ev);
  console.log('[Main Middleware] defineMiddleware completed');
  console.log('=== END MAIN MIDDLEWARE DEBUG ===\n');
  return result;
}
